...
To do this, open `constants\constants.js` with a text editor.  Change the value for `maxRequestsPerCrawl` to a smaller number like 10, e.g. `const maxRequestsPerCrawl = 10;` and save the file.  Start a new purple-hats scan.
