...
export const getProxy = () => {
    if (os.platform() === 'win32') {
        ...
        try {
            internetSettings = execSync('Get-ItemProperty -Path "Registry::HKCU\\Software\\Microsoft\\Windows\\CurrentVersion\\Internet Settings"', { shell: 'powershell.exe' })
                .toString()
                .split('\n');
        }
        catch (e) {
        ...
        const getSettingValue = settingName => internetSettings
...
const urlCheckStatuses = {
    ...
    cannotBeResolved: {
        code: 12,
        message: 'Provided URL cannot be accessed. Please verify your internet connectivity and the correctness of the domain.',
    },
    errorStatusReceived: {
        // unused for now
        code: 13,
    ...
    browserError: {
        code: 17,
        message: 'No browser available to run scans. Please ensure you have Chrome or Edge (for Windows only) installed.',
    },
...
(function (BrowserTypes) {
    BrowserTypes[BrowserTypes["CHROMIUM"] = 0] = "CHROMIUM";
    BrowserTypes[BrowserTypes["CHROME"] = 1] = "CHROME";
