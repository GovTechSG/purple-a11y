...
export const runAxeScript = async (includeScreenshots, page, randomToken, customFlowDetails, selectors = []) => {
    await crawlee.playwrightUtils.injectFile(page, axeScript);
    const results = await page.evaluate(async ({ selectors, saflyIconSelector }) => {
